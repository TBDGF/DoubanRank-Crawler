...
class Img():
        ...
        for _w in range(w):
            for _h in range(h):
                ...
                if calculate_noise_count(gray_img, _w, _h) < k:
                    gray_img.putpixel((_w, _h), 255)
        gray_img_name = "list/captcha.jpg"
        gray_img.save("list/captcha.jpg")
    ...
    def deocr(self):
        img0 = Image.open('list/captcha.jfif')
        img0.save('list/captcha.jpg')
        soluton = self.pre_concert(img0)
        return soluton
